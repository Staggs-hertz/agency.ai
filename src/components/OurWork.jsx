...
const OurWork = () => {
  ...
  const workData = [
    {
      ...
      description: 'We turn bold ideas into powerful digital solutions that connnect, engage...',
  ...
  return (
    <div id='our-work' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      <Title title='Our latest work' desc='From strategy to execution, we craft digital solutions that move your business foward.'/>
