...
const Services = () => {
  ...
  return (
    <div id='services' className='relative flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      ...
      {/*This puts the light-pink hue image behind the services section*/}

      <Title title='How can we help?' desc='From the strategy to execution, we craft digital solutions that move your business foward.'/>

      <div className='flex flex-col md:grid grid-cols-2'>
        {/* These classes creates a grid of two items per row from md above
        while a column of all the items below md*/}
