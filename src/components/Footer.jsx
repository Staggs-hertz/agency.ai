  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        {/* below is the left-side of the footer */}
        <motion.div
          initial={{ opacity: 0, x: -30 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          viewport={{ once: true }}
          className="text-sm text-gray-700 dark:text-gray-400 space-y-5"
        >
          <img
        ...
        {/* below is the right-side of the footer */}
        <motion.div
          initial={{ opacity: 0, x: 30 }}
          whileInView={{ opacity: 1, x: 0 }}
      ...
      >
        <p>Copyright {currentYear} @ agency.io - All Right Reserved.</p>
